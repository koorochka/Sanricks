...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	?>
<div class="content content-nopading">
	<div class="container">
		<div class="row"><div class="col-xs-12"><h1 class="promotion__title text-center-xs">Корзина</h1></div></div>
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" class="basket" name="basket_form" id="basket_form">
...
{
?>
<div class="container color-orange"><? echo ShowError($arResult["ERROR_MESSAGE"]); ?></div>
<?
}